...
const routes: Routes = [
  ...
  {
    path: "dash-board",
    loadChildren: "./dash-board/dash-board.module#DashBoardPageModule"
  },
  {
    path: "new-request",
  ...
  {
    path: "my-pending-approval",
    loadChildren:
      "./my-pending-approval/my-pending-approval.module#MyPendingApprovalPageModule"
  },
  {
  ...
  {
    path: "self-service",
    loadChildren: "./self-service/self-service.module#SelfServicePageModule"
  }
];
